...
const featuredMember = {
  name: "Eksempel Medlem",
  image: "/images/islk-folka.png", // Placeholder - bytt med faktisk bilde
  role: "Medlem siden 2023",
  qa: [
    { q: "Hvorfor begynte du å løpe?", a: "For å holde meg i form og møte nye mennesker." },
    { q: "Hva liker du best med ISLK?", a: "Det sosiale fellesskapet og kaffen etterpå!" },
    { q: "Favoritt løperute?", a: "Ihlen Rundt - perfekt lengde og flott natur." },
    { q: "Beste løperåd?", a: "Start sakte og bygg opp gradvis. Konsistens er nøkkelen!" },
    { q: "Løpemål for i år?", a: "Fullføre et halvmaraton og løpe mer regelmessig." },
    { q: "Favoritt løpesko?", a: "Nike Pegasus - komfortable og allsidige." },
    { q: "Musikk eller stillhet?", a: "Litt av begge - avhenger av humøret!" },
        ...
        <section className="relative overflow-hidden py-20 lg:py-32">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-8">
              <span className="text-gray-900 dark:text-white">Mer enn bare</span>
              <br />
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed mb-12">
              ...
              Målet var enkelt: å fremme helse og trivsel gjennom fellesskap og fysisk aktivitet. 
              I dag er vi et levende fellesskap som samler mennesker fra hele Indre Østfold.
            </p>
              ...
              {[
                {
                  icon: "🤝",
                  title: "Inkludering",
                  description: "Alle er velkomne, uansett nivå eller bakgrunn. Vi heier på hverandre og bygger hverandre opp."
                },
                {
                  icon: "😊",
                  title: "Løpeglede",
                  description: "Det handler ikke om å være raskest, men om å ha det gøy sammen og nyte turen."
                },
                {
                  icon: "☕",
                  title: "Fellesskap",
                  description: "Kaffen etterpå er like viktig som løpeturen. Vi skaper vennskap som varer."
                }
              ].map((value, i) => (
                <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 text-center hover:shadow-xl transition-shadow">
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                    ...
                    eller nettopp har begynt, er du hjertelig velkommen.
                  </p>
                  <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                    Vi har ingen krav til fart eller prestasjon. Her er det løpeglede,
                    samhold og gode samtaler som teller.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {["Nybegynnere", "Mosjonister", "Erfarne", "Alle aldre"].map((tag) => (
                      <span
                        key={tag}
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 p-6">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-500">
                    💬 Klikk for å lese 8 spørsmål
                  </p>
                </div>

                {/* Arrow */}
                <div className="flex-shrink-0">
                  <svg className="w-6 h-6 text-[#FF6B35] group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            ...
            <div className="p-8 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Når</h4>
                  <p className="text-gray-600 dark:text-gray-400">Hver mandag kl. 17:30</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Hvor</h4>
                  <p className="text-gray-600 dark:text-gray-400">
                    Lekeplassen på Tovengtunet<br />
