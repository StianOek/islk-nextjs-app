...
const Social = (): ReactElement => {
  return (
    <section className="relative w-full py-16 sm:py-20 bg-gradient-to-b from-[#F2F2F2] via-[#FFF0E0] to-[#F2F2F2] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 overflow-hidden transition-colors duration-500">
      {/* Dekorative elementer */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-2 left-10 w-40 h-40 sm:w-60 sm:h-60 rounded-full animate-spin-slow bg-[#FC5200]/10 dark:bg-[#FC5200]/20"></div>
        <div className="absolute bottom-20 right-20 w-60 h-60 sm:w-80 sm:h-80 rounded-full animate-spin-slower bg-[#FC5200]/5 dark:bg-[#FC5200]/10"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20 px-4 sm:px-6">
        ...
        <div className="flex flex-col w-full lg:w-1/2 space-y-10 z-10 animate-fade-in">
          ...
          <div className="space-y-4 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#FC5200] dark:text-[#FFA85C]">
          ...
          <div className="space-y-3 text-center lg:text-left">
            <h3 className="text-xl sm:text-2xl font-bold text-[#FC5200] dark:text-[#FFA85C]">
          ...
          <div className="flex justify-center lg:justify-start mt-4">
            <a
              href="#strava-section"
              className="text-white bg-[#FC5200] px-5 sm:px-6 py-3 sm:py-4 rounded-full text-base sm:text-lg font-bold border-2 border-[#FC5200] hover:bg-white hover:text-[#FC5200] transition-colors duration-300 shadow-lg dark:text-gray-900 dark:bg-[#FFA85C] dark:border-[#FFA85C] dark:hover:bg-gray-900 dark:hover:text-[#FFA85C]"
            >
        ...
        <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end animate-fade-in-up">
          <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[28rem] lg:h-[28rem] rounded-3xl overflow-hidden shadow-2xl transform rotate-[-3deg] hover:rotate-0 transition-transform duration-700">
            ...
            />
            <div className="absolute -top-6 -left-6 w-16 h-16 sm:w-24 sm:h-24 bg-[#FC5200]/20 dark:bg-[#FC5200]/30 rounded-full animate-pulse-slow"></div>
            <div className="absolute -bottom-6 -right-6 w-20 h-20 sm:w-32 sm:h-32 bg-[#FC5200]/30 dark:bg-[#FC5200]/20 rounded-full animate-pulse-slower"></div>
          </div>
        </div>
      </div>
    </section>
