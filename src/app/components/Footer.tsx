...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden">
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-[#f2f2f2] to-[#FFF0E0]/60 dark:from-gray-900 dark:to-gray-900" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-start">
          <div>
            <h4 className="text-xl font-bold">Ihlen Sosiale Løpeklubb</h4>
          ...
          <div>
            <h5 className="font-semibold mb-4">Følg oss</h5>
            <div className="flex gap-4">
              <a
                href="#strava-section"
                className="group p-3 rounded-full bg-[#fc5200]/10 dark:bg-[#fc5200]/20 hover:bg-[#fc5200] dark:hover:bg-[#fc5200] transition-colors duration-300 shadow-md"
                aria-label="Strava"
              >
